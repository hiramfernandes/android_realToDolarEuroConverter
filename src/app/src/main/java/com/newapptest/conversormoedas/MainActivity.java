package com.newapptest.conversormoedas;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mViewHolder.textDolar = findViewById(R.id.valor_dolar);
        this.mViewHolder.textEuro = findViewById(R.id.valor_euros);
    ...
    private void clearValues() {
        mViewHolder.textEuro.setText("");
        mViewHolder.textDolar.setText("");
    }
